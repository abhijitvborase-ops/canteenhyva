import { Component, ChangeDetectionStrategy, inject, signal, computed, ElementRef, AfterViewInit, OnDestroy, effect, OnInit } from '@angular/core';
...
export class AnalyticsDashboardComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  // FIX: Local signals to store async data
